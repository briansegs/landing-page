...
* Scroll the viewport to div by it's id
* @param (div-id)
*/
...
/**
* @description The 'for of' loop below will:
...
/**
* @description Listens for when a div is scrolled to
* Sets div to active
*/
